...
public final class FindMeetingQueryTest {
  ...
  public void optionalAttendeeBusyAllDay() {
    // Have each person have different events. We should see two options because each person has
    // split the restricted times. Optional Attendee C should not affect the result as there are
    // no valid time slots which could include them
    //
    // Events  :       |--A--|     |--B--|
    //           |--------------C--------------|
    // Day     : |-----------------------------|
  ...
  public void optionalAttendeeBusyMorning() {
    // Have each person have different events. We should see two options because each person has
    // split the restricted times. Optional C makes it so that a previous available option is no longer
    //
    // Events  :       |--A--|     |--B--|
    //                       |--C--|
    // Day     : |-----------------------------|
  ...
  public void optionalAttendeeIgnored() {
    // Have one person, but make it so that there is just enough room at one point in the day to
    // have the meeting. Optional attendee B should be ignored since there is no way to fit a meeting
    // with them.
    //
    // Events  : |--A--|     |----A----|
    //                 |-B-|
  ...
  @Test
  public void noMandatoryAttendeesTwoOptionalAttendees() {
    // Have two optional people with no mandatory attendees. The gaps in the schedule should be
    // returned.
    //
    // Events  :       |--A--|     |--B--|
    // Day     : |-----------------------------|
  ...
  @Test
  public void noMandatoryAttendeesTwoOptionalAttendeesFull() {
    // Have two optional people with no mandatory attendees. There are no gaps in the schedules,
    // and so no timeRanges should be returned from the meeting query.
    // 
    //
    // Events  : |-------A------||------B------|
    // Day     : |-----------------------------|
