...
!function(t, i, e, s) {
  function o(i, e) {
    ...
    if (navigator.userAgent.match(/(Android)/))
      return this.imageSrc && this.androidFix && !this.$element.is('img') &&
                 this.$element.css({
                   backgroundImage: 'url(' + this.imageSrc + ')',
                   backgroundSize: 'cover',
                   backgroundPosition: this.position
            ...
            .one(
                ...
                function() {
                  h.naturalHeight && h.naturalWidth ||
                      ...
                      o.isSetup || o.setup(), o.sliders.push(h), o.isFresh = !1,
                      o.requestRender()
                }),
  ...
  !function() {
    for (var t = 0, e = ['ms', 'moz', 'webkit', 'o'], s = 0;
         s < e.length && !i.requestAnimationFrame; ++s)
      i.requestAnimationFrame = i[e[s] + 'RequestAnimationFrame'],
      i.cancelAnimationFrame = i[e[s] + 'CancelAnimationFrame'] ||
    ...
    i.requestAnimationFrame || (i.requestAnimationFrame = function(e) {
      ...
      t.extend(o.prototype, {
        ...
        refresh: function() {
          ...
          var t, i = o.winHeight, e = o.docHeight,
                 s = Math.min(this.boxOffsetTop, e - i),
                 h = Math.max(this.boxOffsetTop + this.boxHeight - i, 0),
                 r = this.boxHeight + (s - h) * (1 - this.speed) | 0,
                 a = (this.boxOffsetTop - s) * (1 - this.speed) | 0;
          r * this.aspectRatio >= this.boxWidth ?
              (this.imageWidth = r * this.aspectRatio | 0, this.imageHeight = r,
              ...
              (this.imageWidth = this.boxWidth,
               ...
               this.offsetLeft = 0, t = this.imageHeight - r,
               'top' == this.positionY ?
          ...
          this.boxOffsetBottom > t && this.boxOffsetTop <= s ?
              ...
              this.$mirror.css({
                transform: 'translate3d(' + this.mirrorLeft + 'px, ' +
                    (this.mirrorTop - e) + 'px, 0px)',
                visibility: this.visibility,
                height: this.boxHeight,
                width: this.boxWidth
              }),
              this.$slider.css({
                transform: 'translate3d(' + this.offsetLeft + 'px, ' +
                    this.offsetTop + 'px, 0px)',
                position: 'absolute',
        ...
        setup: function() {
          ...
          if (!this.isReady) {
            var h = this, r = t(e), a = t(i), n = function() {
              o.winHeight = a.height(), o.winWidth = a.width(),
              o.docHeight = r.height(), o.docWidth = r.width()
            }, l = function() {
              var t = a.scrollTop(), i = o.docHeight - o.winHeight,
