...
public final class FindMeetingQueryTest {
  ...
  public void everyAttendeeIsConsideredWithBusyOptional() {
    ...
    // split the restricted times, and the optional attendee is busy.
    //
    // Events  :       |--A--|     |--B--|
    // Optional: |--------------C--------------|
    // Day     : |-----------------------------|
  ...
  @Test
  public void everyAttendeeIsConsideredWithOnlyOptionals() {
    // Have each person have different events. We should see three options because only optional
    // people have split the restricted times.
    //
    // Event: None
    // Optional :      |--A--|     |--B--|
    // Day     : |-----------------------------|
  ...
  @Test
  public void everyAttendeeIsConsideredWithOnlyBusyOptionals() {
    // Have each person have different events. We should see no options because the optional
    // attendees have no gap.
    //
    // Event: None
    // Optional :|--------A-------||-----B-----|
    // Day     : |-----------------------------|
  ...
  public void everyAttendeeIsConsideredWithOptional() {
    // Have each person have different events. We should see two options because each person has
    // split the restricted times, and the optional attendee is included.
    //
    // Events  :       |--A--|     |--B--|
    // Optional:             |--C--|
    // Day     : |-----------------------------|
  ...
  public void justEnoughRoomIgnoreOptional() {
    ...
    // have the meeting. The optional attendee is ignored as the interval would shrink.
    //
    // Events  : |--A--|     |----A----|
    // Optional:        |-B-|
    // Day     : |---------------------|
    ...
    Collection<Event> events = Arrays.asList(
        ...
        new Event("Event 2", TimeRange.fromStartEnd(TIME_0900AM, TimeRange.END_OF_DAY, true),
            Arrays.asList(PERSON_A)),
        new Event("Event 3", TimeRange.fromStartEnd(TIME_0830AM, DURATION_15_MINUTES, true),
            Arrays.asList(PERSON_B)));
